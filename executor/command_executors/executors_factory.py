...
def create(command_type: CommandType, task_manager: TaskManager, lot_manager: LotManager) -> CommandExecutor:
    """
    :raises:
    ...
    if command_type == CommandType.SELLING_LOTS:
        return SellingLotsExecutor(task_manager, lot_manager)
